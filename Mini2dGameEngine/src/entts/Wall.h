...
{
public:
    Wall(Global* globalVariables, std::string myName, myMath::Transform initialTransform) : EntityMaster(globalVariables, myName, initialTransform)
    {
        ...
        collisionVertexArray.append(sf::Vertex(sf::Vector2f(-700, -10)));
        collisionVertexArray.append(sf::Vertex(sf::Vector2f(700, -10)));
        collisionVertexArray.append(sf::Vertex(sf::Vector2f(700, 10)));
        collisionVertexArray.append(sf::Vertex(sf::Vector2f(-700, 10)));
